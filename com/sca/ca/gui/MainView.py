...
class MainView(tk.Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.filename_frame.grid(row=5, columnspan=5, sticky="nsew")
        self.folder_frame.grid(row=6, columnspan=5, sticky="nsew")
        ...
        self.step1_instructions = tk.Label(self.faclist_frame, text="Select facility list file",
        ...
        # Third step - choose a filename
        self.step3 = tk.Label(self.filename_frame,
        ...
        # Fourth step - choose an output folder
        self.step4 = tk.Label(self.folder_frame,
        ...
        self.step4_instructions = tk.Label(self.folder_frame, text="Select output folder",
                                           font=SMALL_TEXT_FONT, bg='white', anchor="w")
        self.step4_instructions.grid(row=3, column=2)
        self.fileLabel.bind("<Button-1>", partial(self.browse, self.step4_instructions))
        self.step4_instructions.bind("<Button-1>", partial(self.browse, self.step4_instructions))
